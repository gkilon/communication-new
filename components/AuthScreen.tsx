    ...
    <div className="bg-gray-800 p-8 md:p-12 rounded-3xl shadow-2xl text-center max-w-lg w-full mx-auto animate-fade-in-up border border-gray-700 relative">
      ...
      {!isLogin && inviteOrgId && (
        <div className="mb-8 text-right bg-cyan-900/20 p-5 rounded-2xl border-2 border-cyan-500/30">
            <label className="block text-cyan-400 text-sm mb-2 font-black">הצוות שלך:</label>
            <select
                value={selectedTeam}
      ...
      {!isLogin && !inviteOrgId && (
        <div className="mb-8 text-right bg-cyan-900/20 p-5 rounded-2xl border-2 border-cyan-500/30">
            <label className="block text-cyan-400 text-sm mb-2 font-black">שם הארגון שלך:</label>
            <input
                type="text"
                value={orgName}
