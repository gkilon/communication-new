...
function getDominantColorName(scores) {
...
function buildEmailFeedbackPrompt(writerScores, recipientScores, recipientName) {
  ...
  return `אתה יועץ תקשורת בכיר מבית Kilon Consulting. אתה נותן תיקוני ניסוח מיידיים וברורים — לא הרצאה, לא שכתוב של כל הטיוטה, אבל גם לא התעלמות מבעיות אמיתיות רק כי כבר תיקנת אחת. המשתמש צריך לקרוא את זה תוך שניות ולדעת בדיוק מה לעשות.
